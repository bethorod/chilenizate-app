...
// import { Brain } from 'lucide-react'; // TODO(juegos): reactivar junto con Pasapalabras.
// import { Trophy } from 'lucide-react'; // TODO(auth): reactivar junto con el tab Quiz Chile.
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { Button } from '@/components/ui/button';
// import Pasapalabras from '@/components/games/Pasapalabras'; // TODO(juegos): reactivar cuando se retome este juego.
...
export default function Juegos() {
  useEffect(() => {
    ...
    meta?.setAttribute('content', 'Aprende jugando con Ahorcado Dieciochero y Ruta del 18 sobre Chile.');
  }, []);
      ...
      <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
        <Tabs defaultValue="ahorcado" className="w-full">
          <TabsList className="mb-8 grid h-auto w-full grid-cols-2 rounded-2xl bg-white p-2 shadow-sm ring-1 ring-slate-200">
            ...
            {/* TODO(juegos): reactivar cuando se retome Pasapalabras.
          ...
          {/* TODO(juegos): reactivar junto con el tab Pasapalabras.
